...
<head>
    ...
    <title>Update une rubrique</title>
            ...
            se Déconnecter
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="background-color: #8A61B1; border-color: #8A61B1;">Mise à jour rubrique</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form  action="include/confirmrubrique.php" enctype="multipart/form-data" method="post">

                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="hidden" value="<?php echo $_GET['idRubrique'];?>" name="idRubrique" required>
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            value="<?php echo $_GET['nomRubrique'];?>" name="nomRubrique" required>
                                    </div>
                                </div>
                                <input type="submit" class ="btn btn-primary btn-user btn-block" value="update la rubrique" name='updaterubrique'>
                            </form>
                        </div>
                    </div>
