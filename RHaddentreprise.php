...
<head>
    ...
    <title>Ajouter des Entreprises</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ajouter des Entreprises</h1>
                    </div>
                        ...
                        <div class="card-body">
                            <form  action="include/confirmentreprise.php" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Nom d'Entreprise" name="nomEntreprise" required>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Createur" name="createdBy" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Date de creation" name="createDate" onfocus="(this.type='date')" required>
                                    </div>
                                </div>
                                <input type="submit" class ="btn btn-primary btn-user btn-block" value="Ajouter l'entreprise" name='addentreprise'>
                            </form>
                        </div>
                    </div>
