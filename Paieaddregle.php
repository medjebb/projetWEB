                            ...
                            <form  action="include/confirmregle.php" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <button type="button" onclick="addValue('NombreHS')" class="btn btn-secondary btn-icon-split" style="margin : 10px;"><span class="text">NombreHS</span></button>
                                        ...
                                        <button type="button" onclick="addValue('TauxHS')" class="btn btn-secondary btn-icon-split" style="margin : 10px;"><span class="text">TauxHS</span></button>                                  
